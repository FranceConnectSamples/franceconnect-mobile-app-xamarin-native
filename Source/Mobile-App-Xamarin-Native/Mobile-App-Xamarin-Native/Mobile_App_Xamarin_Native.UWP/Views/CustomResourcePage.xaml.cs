...
namespace Mobile_App_Xamarin_Native.UWP.Views
{
    ...
    /// </summary>
    public sealed partial class CustomResourcePage : Page
    {
        public CustomResourcePageViewModel PageViewModel { get; set; }

        public CustomResourcePage()
        {
            this.InitializeComponent();
            PageViewModel = new CustomResourcePageViewModel();
        }

        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            PageViewModel.CustomResource = (CustomResource)e.Parameter;
